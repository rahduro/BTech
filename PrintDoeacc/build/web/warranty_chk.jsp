<%-- 
    Document   : warranty_chk
    Created on : Oct 7, 2009, 8:06:50 PM
    Author     : rinki
--%>
...
<html>
    ...
    <body>
        <%!
            String usrid="",paswd="",us_type="",vld_dt="",srl="";
        ...
        <%
            ...
            srl = request.getParameter("serial").trim();
            ...
            <table id="out" align="center" width="650" border="0" cellspacing="0" cellpadding="">
                ...
                <tr id="row2">
                    <td valign="top" id="left-col" width="" style="">
                        ...
                        <br>
                        <!--<img id="image3" src="Final Images/Care_ Young and Elderly hands.jpg" width="190" height="160" alt="Care_ Young and Elderly hands"/>-->
                    ...
                    <td id="body" colspan="5" width="" bgcolor="">
                        <%
                            ...
                            try
                            {
                                rs = stmt.executeQuery("select warranty_xp_dt from saled_product where serial_no='"+srl+"'");
                                if(rs.next())
                                    {
                                        String temp[] = rs.getString("warranty_xp_dt").split(" ");
                                        out.print("Your Product Expiry Date is : "+temp[0]);
                                    }                                
                                else
                                    out.print("Your Product Serial Number is not Valid!");
                                rs.close();
                                stmt.close();
                                con.close();
                            }
