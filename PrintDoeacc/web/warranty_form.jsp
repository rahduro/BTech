<%-- 
    Document   : warranty
    Created on : Oct 7, 2009, 7:57:46 PM
    Author     : rinki
--%>
            ...
            <table id="out" align="center" width="650" border="0" cellspacing="0" cellpadding="">
                ...
                <tr id="row2">
                    ...
                    <td id="body" colspan="5" width="" bgcolor="">
                        ...
                        <div id="left">
                            <h1>Warranty Checking Form</h1>
                            <form name="WF" action="warranty_chk.jsp">
                                <table>
                                    <tr>
                                        <td>Enter Product Serial No.</td>
                                        <td><input type="text" name="serial" value="" size="15" /></td>
                                        <!--<td><br></td>
                                    </tr>
                                    <tr>-->
                                        <td colspan="" align=""><input type="submit" value="Check Warranty" name="chkwar" /></td>
                                    </tr>
                                </table>
                            </form>
                        </div>
