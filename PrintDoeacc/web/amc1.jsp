...
<html>
    <head>
        ...
        <title>Accidental Damage Protection</title>
                                ...
                                <thead>
                                    <tr valign="top">
                                        <th colspan="2" align="left" style="border: none; color: #A05F3B; font-family: sans-serif">
                                            <input style="background: white; border: none; font-size: xx-large; font-weight: bold; color: #4169E1" type="text" size="27" name="care" readonly="readonly" value="Accidental Damage Protection" />
                                            <br>Reliable coverage from the unexpected
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td rowspan="2" width="55%" align="justify" style="border-left: none; border-right: none; border-bottom: none; border-top-style: solid; border-top-color: blue; border-top-width: thick; font-family: cursive">
                                            Whether you drop your printer, spill coffee on your keypad or leave your printer out in the rain, you’re covered. You will always enjoy the convenience of 24/7 assistance from an our technician. And rest assured your product will be up and running quickly.
                                            <p>You can purchase this plan during the standard warranty period. Buy your plan at the same time you purchase your our product to get the most coverage and value. Because accidents are unavoidable, and the costs associated with them an really add up.
                                        </td>
                                        <td style="border: none; background-color: #00008B; color: white; font-family: sans-serif; font-size: large">
                                            Purchase Accidental Damage Protection and get:
                                        </td>
                                    </tr>
                                    <tr>                                        
                                        <td bgcolor="#6898d0" style="border: none">
                                            <ul style="padding: 1em;">
                                                <li style="list-style-type: square;color: white; border-bottom-style: solid; border-bottom-width: thin; border-top-style: solid; border-top-width: thin; border-color: #00008B; padding: 10px 0px 10px; font-family: sans-serif; font-size: medium">Upgraded coverage for your printer for up to 4 continuous years</li>
                                                <li style="list-style-type: square;color: white; border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #00008B; padding: 10px 0px 10px; font-family: sans-serif; font-size: medium">Coverage for damage caused by spills, drops and electrical surges</li>
                                    ...
                                    <tr>
                                        <td colspan="2" align="justify" style="border-left: none; border-right: none; border-bottom: none; border-top-style: solid; border-top-color: #8B4513; border-top-width: medium; font-size: larger">
                                            <p><b>Extended coverage for your printer begins on its purchase date and ends 2 years from that date.</b><br> You'll get the most coverage if you buy this 2-year plan when you purchase your printer. For example, if you buy it 3 months after you buy the printer, you'll get enhanced coverage for the remaining 9 months of your standard 1-year warranty, plus 1 additional year.
                                            ...
                                            <table id="price" border="0" width="100%" cellspacing="1" cellpadding="3">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="35%" align="center" style="color: red; font-size: x-large">Rs.3000</td>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td align="center" style="color: blue; font-size: large; font-weight: bold">(4 Years)</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
