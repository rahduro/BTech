...
public class DealerComplete{
    ...
    {
        String file_name=ref.Database_Path+"\\Secret_Hashes.txt";
    ...
    {
        String file_name=ref.Database_Path+"\\Participants_database.txt";
    ...
    {
        String file_name=ref.Database_Path+"\\Secret"+Integer.toString(n+1)+"_Database.txt";
        FileWriter fout = new FileWriter(file_name);
        fout.write("Bits of Prime : "+ref.Prime_Bit+"\n");
